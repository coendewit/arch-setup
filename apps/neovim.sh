...
create_symlink "$SCRIPT_DIR/neovim/theme.lua" ~/.config/nvim/lua/plugins/theme.lua
create_symlink "$SCRIPT_DIR/neovim/transparency.lua" ~/.config/nvim/plugin/after/transparency.lua
